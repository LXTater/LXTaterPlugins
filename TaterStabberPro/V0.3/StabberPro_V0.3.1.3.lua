...
--SignalTable Annotation to kill language warnings
---@class SignalTable
---@field OnPresetAdd fun()
---@field OnOpenSettings fun(caller)
---@field OnCancel fun()
---@field OnBuild fun()
---@field OnSeqNumChanged fun(c)
---@field OnSeqNameChanged fun(c)
---@field OnXGroupChanged fun(c)
---@field OnXBlockChanged fun(c)
---@field OnXWingsChanged fun(c)
---@field OnShuffleSeedChanged fun(c)
---@field OnOffFadeChanged fun(c)
---@field OnOffDelayChanged fun(c)
---@field OnModeStraight fun()
---@field OnModeShuffle fun()
---@field OnModeScatter fun()
---@field OnPresetClear fun()
---@field OnOpenGroupPicker fun(caller)
---@field OnOpenPresetPicker fun()
---@type SignalTable
---
