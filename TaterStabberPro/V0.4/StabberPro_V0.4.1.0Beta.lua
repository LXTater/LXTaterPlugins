...
local function deleteEmptyCues(seqNum)
 ...
 local titleBar = baseInput:Append("TitleBar")
  ...
  mStraight.State=1
  mStraight.Anchors={left=1,right=1,top=5,bottom=5}
  ...
  mShuffle.State=0
  mShuffle.Anchors={left=2,right=2,top=5,bottom=5}
  ...
  mScatter.State=0
  mScatter.Anchors={left=3,right=3,top=5,bottom=5}
  ...
  signalTable.OnModeStraight = function()
    if state.selectedMode ~= 1 then setMode(1) end
  end
  signalTable.OnModeShuffle  = function()
    if state.selectedMode ~= 2 then setMode(2) end
  end
  signalTable.OnModeScatter  = function()
    if state.selectedMode ~= 3 then setMode(3) end
  end
