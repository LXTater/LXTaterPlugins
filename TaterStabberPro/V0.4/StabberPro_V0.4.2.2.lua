-- grandMA3 Plugin: StabberPro GUIUpdate and Finilization Efforts
-- Author: LXTater
-- Version: 0.4.2.2
...
local function updateSeqStatus()
  ...
  if seqExists(seqNum) then
    ...
    seqStatusLabel.TextAlignmentH = "Center"
    seqStatusLabel.TextColor = 1.32  -- Red for existing
  else
    seqStatusLabel.Text = "Sequ State: Empty"
    seqStatusLabel.TextAlignmentH = "Center"
    seqStatusLabel.TextColor = 1.33  -- Green for new/empty
  end
end
