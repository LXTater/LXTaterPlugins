...
return function()
  ...
  local function openPresetPicker()
    ...
    -- child window
    local pop = overlay:Append("BaseInput"); pop.Name = "PresetPicker"; pop.W = 1200; pop.H = 0; pop.Columns=1; pop.Rows=2; pop[1][1].SizePolicy="Fixed"; pop[1][1].Size="60"; pop[1][2].SizePolicy="Fixed"; pop[1][2].Size="600"; pop.CloseOnEscape="Yes"
    ...
    frame[1][1].SizePolicy = "Fixed"; frame[1][1].Size = 200
    frame[2][1].SizePolicy = "Fixed"; frame[2][1].Size = 1000
